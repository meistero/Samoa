...
#if defined(_HEAT_EQ)
	MODULE Heat_Eq_Midpoint_Timestep_1
...
#		define _GT_INNER_NODE_LAST_TOUCH_OP			midpoint_timestep_1_node_last_touch_op
...
#		include "SFC_generic_traversal_ringbuffer.f90"
		...
		subroutine midpoint_timestep_1_cell_last_touch_op(traversal, section, cell)
			...
			call midpoint_timestep_1_post_dof(grid, cell%data_pers%T, cell%data_pers%T_temp, cell%data_temp%r, cell%data_temp%mat_mass_diagonal)
		end subroutine
		...
		subroutine midpoint_timestep_1_edge_last_touch_op(traversal, section, edge)
			...
			call midpoint_timestep_1_post_dof(grid, edge%data_pers%T, edge%data_pers%T_temp, edge%data_temp%r, edge%data_temp%mat_mass_diagonal)
		end subroutine

		subroutine midpoint_timestep_1_node_last_touch_op(traversal, section, node)
			type(t_grid_section), intent(inout)												:: grid
			type(t_node_data), intent(inout)				:: node

			call midpoint_timestep_1_post_dof(grid, node%data_pers%T, node%data_pers%T_temp, node%data_temp%r, node%data_temp%mat_mass_diagonal)
		end subroutine
		...
		subroutine midpoint_timestep_1_post_dof(grid, T, T_temp, r, mat_mass_diagonal)
			type(t_grid_section), intent(inout)									:: grid
			...
			T_temp = T
			T = T + 0.5_GRID_SR * grid%r_dt * r / mat_mass_diagonal
		end subroutine
	END MODULE

	MODULE Heat_Eq_Midpoint_Timestep_2
		use SFC_node_traversal
...
#		define _GT_INNER_NODE_LAST_TOUCH_OP		midpoint_timestep_2_node_last_touch_op
#		define _GT_EDGE_LAST_TOUCH_OP			timestep_bnd_edge_last_touch_op
#		define _GT_NODE_LAST_TOUCH_OP			timestep_bnd_node_last_touch_op
...
#		include "SFC_generic_traversal_ringbuffer.f90"
		...
		subroutine midpoint_timestep_2_cell_last_touch_op(traversal, section, cell)
			...
			call midpoint_timestep_2_post_dof(grid, cell%data_pers%T, cell%data_pers%T_temp, cell%data_temp%r, cell%data_temp%mat_mass_diagonal)
		end subroutine
		...
		subroutine midpoint_timestep_2_edge_last_touch_op(traversal, section, edge)
			...
			call midpoint_timestep_2_post_dof(grid, edge%data_pers%T, edge%data_pers%T_temp, edge%data_temp%r, edge%data_temp%mat_mass_diagonal)
		end subroutine
		...
		subroutine midpoint_timestep_2_node_last_touch_op(traversal, section, node)
			...
			call midpoint_timestep_2_post_dof(grid, node%data_pers%T, node%data_pers%T_temp, node%data_temp%r, node%data_temp%mat_mass_diagonal)
		end subroutine
		...
		subroutine midpoint_timestep_2_post_dof(grid, T, T_temp, r, mat_mass_diagonal)
			type(t_grid_section), intent(inout)												:: grid
	...
	MODULE Heat_Eq_Midpoint_Timestep
		use SFC_node_traversal

		use Samoa_heat_eq
		use Heat_Eq_Midpoint_Timestep_1
		use Heat_Eq_Midpoint_Timestep_2
