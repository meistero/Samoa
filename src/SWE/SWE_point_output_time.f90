...
#		define _GT_NAME					t_swe_point_output_time_traversal
...
#		include "SFC_generic_traversal_ringbuffer.f90"
  ...
  subroutine pre_traversal_grid_op(traversal, grid)
		type(t_swe_point_output_time_traversal), intent(inout)		:: traversal
		...
		allocate (r_testpoints(size(cfg%r_testpoints, dim=1), 4), stat = erro)
