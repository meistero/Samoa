...
#       if defined(_ASAGI_TIMING)
            traversal%children(i_first_local_section : i_last_local_section)%current_stats%r_asagi_time = dble(i_last_local_section - i_first_local_section + 1) * sections%stats%r_asagi_time
#       endif
