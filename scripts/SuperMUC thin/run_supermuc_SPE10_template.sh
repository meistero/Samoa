...
echo "  Running SPE10..."
mpiexec -n $processes ./bin/samoa_darcy$postfix -lbsplit -lbserial -fperm "data/darcy_five_spot/spe_perm_renamed.nc" -fpor "data/darcy_five_spot/spe_phi_renamed.nc" -sections $sections -threads $threads -dmin 0 -dmax $dmax -xmloutput .false. -tout 86.4e4 -tmax 172.8e6 -epsilon 1.0e-5 -S_ref_th 1.0e2 -p_ref_th $p_ref_th -courant 1.0 -output_dir $output_dir -nmax 20
echo "  Done."
