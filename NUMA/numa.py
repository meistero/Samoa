...
a1_bathymetry_PVLookupTable = GetLookupTableForArray( "bathymetry", 1, RGBPoints=[-1.1907853395166852, 0.23137254901960785, 0.2980392156862745, 0.7529411764705882, -0.440115, 0.3333333333333333, 0.0, 0.0, 0.38138853825568547, 0.0, 0.6666666666666666, 0.0], VectorMode='Magnitude', NanColor=[0.25, 0.0, 0.0], ColorSpace='RGB', HSVWrap=0, ScalarRangeInitialized=1.0 )
...
RenderView1.CameraFocalPoint = [0.4999999999999998, 0.4999999999999998, -0.05529255792498585]
